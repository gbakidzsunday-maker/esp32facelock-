...
ESP32_IP = "192.168.1.50"     # <-- set this to your ESP32's IP from Serial Monitor
GRANT_KEY = "changeme123"     # <-- must match GRANT_KEY in the .ino sketch

POLL_INTERVAL = 1.0           # seconds between recognition attempts
MATCH_THRESHOLD = 70          # LBPH distance - LOWER is a better match. Tune this.
GRANT_COOLDOWN = 20           # seconds - don't re-trigger immediately after a grant
...
if __name__ == "__main__":
    ...
    print(f"Open http://localhost:5000 to register faces.")
